...
import { MapPin, Info, CheckCircle2, Paperclip, X, FileImage, FileText, File } from 'lucide-react';
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Submit a manual UAV sighting report. Click on the map to set coordinates.
          </DialogDescription>
        </DialogHeader>
          ...
          {selectedLocation ? (
            <Alert className="border-green-500/50 bg-green-50 dark:bg-green-950/20">
              ...
              <AlertDescription className="text-green-800 dark:text-green-200">
                <strong>Location set from map:</strong> <span className="text-green-950 dark:text-green-100">{selectedLocation.lat.toFixed(6)}, {selectedLocation.lng.toFixed(6)}</span>
              </AlertDescription>
            </Alert>
          ) : (
            <Alert>
              ...
              <AlertDescription>
                Click anywhere on the map to set the event location before submitting.
              </AlertDescription>
            </Alert>
          )}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground mt-1.5">
                Other detection types (photo, microphone, written) are automatically reported via backend systems.
              </p>
            </div>
          </div>
