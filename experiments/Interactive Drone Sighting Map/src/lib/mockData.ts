...
const sensorTypes: DroneEvent['sensor_type'][] = ['microphone', 'camera', 'radar', 'visual', 'manual'];
const detectionSources: DroneEvent['detection_source'][] = ['acoustic', 'optical', 'electromagnetic', 'human'];
const classifications: DroneEvent['classification'][] = ['confirmed', 'probable', 'possible', 'unknown'];
...
export const mockEvents: DroneEvent[] = [
  ...
  {
    detection_id: 'DET-001-20251004-1530',
    timestamp_utc: new Date(Date.now() - 1000 * 60 * 15),
    ingestion_time: new Date(Date.now() - 1000 * 60 * 14),
    sensor_id: 'SNR-BP-007',
    sensor_type: 'visual',
    detection_source: 'optical',
    drone_id: 'UAV-UNKNOWN-847',
  ...
  {
    detection_id: 'DET-002-20251004-1445',
    timestamp_utc: new Date(Date.now() - 1000 * 60 * 45),
    ingestion_time: new Date(Date.now() - 1000 * 60 * 44),
    sensor_id: 'SNR-CAM-012',
    sensor_type: 'camera',
    detection_source: 'optical',
    drone_id: 'UAV-UNKNOWN-848',
  ...
  {
    detection_id: 'DET-003-20251004-1330',
    timestamp_utc: new Date(Date.now() - 1000 * 60 * 120),
    ingestion_time: new Date(Date.now() - 1000 * 60 * 118),
    sensor_id: 'SNR-MIC-005',
    sensor_type: 'microphone',
    detection_source: 'acoustic',
    drone_id: undefined,
  ...
  {
    detection_id: 'DET-004-20251004-1230',
    timestamp_utc: new Date(Date.now() - 1000 * 60 * 180),
    ingestion_time: new Date(Date.now() - 1000 * 60 * 179),
    sensor_id: 'SNR-VIS-003',
    sensor_type: 'visual',
    detection_source: 'human',
    drone_id: 'UAV-UNKNOWN-849',
    classification: 'confirmed',
    latitude: 53.4521,
    longitude: 23.3345,
    altitude_m: 180,
  ...
  {
    detection_id: 'DET-005-20251004-1130',
    timestamp_utc: new Date(Date.now() - 1000 * 60 * 240),
    ingestion_time: new Date(Date.now() - 1000 * 60 * 238),
    sensor_id: 'SNR-RAD-008',
    sensor_type: 'radar',
    detection_source: 'electromagnetic',
    drone_id: 'UAV-UNKNOWN-850',
    classification: 'confirmed',
    latitude: 52.6789,
    longitude: 23.3789,
    altitude_m: 120,
