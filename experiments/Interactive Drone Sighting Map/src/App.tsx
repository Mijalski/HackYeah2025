...
export default function App() {
  ...
  const AUTO_REFRESH_MS = 150000; // 15 sec
  ...
  const handleEvacuationIssue = (
    ...
    const incident = mockClusteredEvents.find(
      (i) => i.id === orderData.incidentId
    );
      ...
      <header className="border-b border-border bg-card px-6 py-4 shrink-0">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Button onClick={toggleMilitaryView} style={{ width: "120px" }}>
